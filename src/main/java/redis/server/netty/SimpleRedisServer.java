...
import java.util.*;
import static redis.bytebuffer.IntegerReply.integer;
import static redis.bytebuffer.BulkReply.NIL_REPLY;
import static redis.bytebuffer.StatusReply.OK;
import static redis.bytebuffer.StatusReply.QUIT;
